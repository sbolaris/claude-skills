...
**When to use:** After writing or modifying Nextflow pipeline code. Extends the general `/test` skill with Nextflow-specific patterns.

**Captured from:** SEQuoia-Complete and Sequoia_express_toolkit test profile review.
...
ls work/xx/yyyyyy*/   # find failed task
