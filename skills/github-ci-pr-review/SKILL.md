...
description: "Diagnose failing CI jobs, fix lint errors, resolve merge conflicts, and clean up branches to get a PR merged."
tags: [ci, pr, github, lint, merge-conflicts]
---
...
Typical 3-job layout for a Nextflow pipeline repo:
