---
name: nextflow-dsl2
description: "Build, modify, and test Nextflow DSL2 pipelines — project structure, process and channel patterns, and configuration."
tags: [nextflow, dsl2, pipelines, bioinformatics]
---
...
├── Dockerfile                 # Single container or see docker-containers.md for multi-container
├── conf/
