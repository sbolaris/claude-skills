...
description: Two-tier documentation pattern (high-level + technical reference) after completing a feature
tags: [documentation, docs, two-tier, technical-writing]
---
