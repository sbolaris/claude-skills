---
name: umi-tools
description: "Evaluate and select UMI (Unique Molecular Identifier) deduplication tools for sequencing pipelines."
tags: [umi, deduplication, bioinformatics, sequencing]
---
...
| **rumi** | Rust | fork of umi-tools | Optimized for paired-end RNA-seq | Internal binary, production |
