---
name: sub-agent-commands
description: Setting up Claude Code slash commands (/plan, /research, /test, /rework, /document) for structured project workflows
tags: [claude-code, slash-commands, sub-agents, workflow]
---
