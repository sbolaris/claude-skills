...
description: "Build Docker containers for Nextflow and other pipeline tools, with version-locked conda and pip dependencies for reproducibility."
tags: [docker, containers, nextflow, conda]
---
