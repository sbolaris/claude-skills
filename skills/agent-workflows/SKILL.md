...
description: "Coordinate specialized agents (research, engineering, QA, documentation, presentation) into a working team. Use when deciding which agent handles what and in what order."
