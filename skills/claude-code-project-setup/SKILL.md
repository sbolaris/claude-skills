...
description: "Set up Claude Code on a new or existing project — what belongs in CLAUDE.md and how to add slash-command workflows."
tags: [claude-code, claude-md, setup, slash-commands]
---
...
| `/document <feature>` | Write high-level + technical docs; update index | See documentation-patterns.md |
